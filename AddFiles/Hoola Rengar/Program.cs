...
namespace HoolaRengar
{
    public class Program
    {
        ...
        static void OnGameLoad(EventArgs args)
        {
            ...
            Game.PrintChat("Hoola Rengar - Loaded Successfully, Good Luck! :)");
        ...
        private static void LaneClear()
        {
            ...
            if (Minions[0].IsValidTarget() && Minions.Count > 0 && !Minions[0].IsDead)
            {
                ...
                if (Player.Distance(Minions[0].ServerPosition) <= E.Range && Player.Mana != 5 && !Player.IsWindingUp) E.Cast(Minions[0].ServerPosition);
            }
        }
        private static void JungleClear()
        {
            ...
            if (Mobs[0].IsValidTarget() && Mobs.Count > 0 && !Mobs[0].IsDead)
            {
                ...
                if (Player.Distance(Mobs[0].ServerPosition) <= E.Range && Player.Mana != 5 && !Player.IsWindingUp) E.Cast(Mobs[0].ServerPosition);
            }
        }
